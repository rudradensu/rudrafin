...
- [NEW_DEVELOPER_ONBOARDING.md](../NEW_DEVELOPER_ONBOARDING.md) — single-document onboarding guide
- [DEVELOPER_GUIDE.md](../DEVELOPER_GUIDE.md) — contributor workflow reference
- [TESTING_GUIDE.md](../TESTING_GUIDE.md) — detailed test reference
- [INSTALLATION.md](../INSTALLATION.md) — all deployment options
